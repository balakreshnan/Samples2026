# Samsung SmartThings Agentic AI Applications - Smart Home Agents

## Introduction

- This document describes how to build agentic AI applications using Samsung SmartThings platform.
- SmartThings is a popular platform for smart home automation.
- How do we list all devices and find status of each device using agentic AI.
- Enable natural language interface to interact with smart home devices.
- Using Agent framework to build agents that can interact with SmartThings API.
- Using local functions to interact with devices in local network.
- Using Azure open ai gpt 5.2 model.
- Build a streamlit based web application to interact with smart home devices.

## Prerequisites

- Azure Subscription
- Microsoft Foundry - Standard Agent Setup for Enterprise
- Samsung SmartThings Account
- Get a PAT (Personal Access Token) from SmartThings Developer portal.
- PAT token only last for 24 hours or 1 day.
- Visual Studio Code with Python environment setup.
- I am using python 3.13 environment.
- install streamlit package also.

## Code

- First create a new python file smartthings_agent.py
- our goal is to build a nice UI using streamlit to interact with smart home devices.
- Ability to show the agent output and also display agent events in the UI.
- I am building a split UI.
...
- Now configure the Token and other parameters.
...
- Now lets do the streamlit UI configuration.
...
- Now we create 2 functions like get_devices and get_device_logs to interact with smartthings api.
- Both will be used as tools by the agent.
- I am running locally to access by smart home devices.
...
- Now lets create the agent using azure ai project agent framework.
- Also with streamlit UI to interact with the agent.
...
- Now lets run the main UI function.
...
- Make sure you python environment is activated.
- then run the streamlit application using below command.

```bash
streamlit run smartthings_agent.py
```

- will open the streamlit UI in the browser.
- type in View all my devices to see the list of devices.

![info](https://github.com/balakreshnan/Samples2026/blob/main/Foundry/images/smartthing-1.jpg 'fine tuning model')

- now copy the device id and then as for show me current status of device id xxxx.

![info](https://github.com/balakreshnan/Samples2026/blob/main/Foundry/images/smartthing-2.jpg 'fine tuning model')

- Now we can add functionality to control the devices also.
- Have fun building smart home agents using Samsung SmartThings and Azure AI Projects!