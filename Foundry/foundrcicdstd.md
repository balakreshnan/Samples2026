# Github CI/CD for Foundry Standard Agent Setup for Single environment

## Overview

- This document outlines the steps to set up a Continuous Integration/Continuous Deployment (CI/CD) pipeline for Foundry using GitHub Actions for a single environment for Foundry Standard Agent Setup.
...
- Azure Subscription with Standard Agent Setup Foundry deployed.
...
- Provide Azure AI Developer, Azure AI User role to the service principal on the Foundry resource group. Was needed for Agent Eval and Red Team scans.
...
- 
![info](https://github.com/balakreshnan/Samples2026/blob/main/Foundry/images/foundrycicdgithubstd-1.jpg 'fine tuning model')

![info](https://github.com/balakreshnan/Samples2026/blob/main/Foundry/images/foundrycicdgithubstd-2.jpg 'fine tuning model')
