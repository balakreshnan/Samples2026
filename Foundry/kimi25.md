...
- Deploy Kimi 2.5 model in your Foundry workspace.
...
- idea here is to create custom agents.
- 2 agents are research agent, writer agent
- using microsoft agent framework to create agents
...
- You should see output from both agents, along with their execution times.
- You can modify the agent instructions and user prompt to fit your specific use case.
- This example demonstrates how to create and run multiple agents using the Kimi 2.5 model in Microsoft Foundry with Python code.

![info](https://github.com/balakreshnan/Samples2026/blob/main/Foundry/images/kimi25-1.jpg 'fine tuning model')

- you can see both execution started at the same time.

## Conclusion

- This guide provided a basic example of how to use the Kimi 2.5 model in Microsoft Foundry with Python code.
- You can expand upon this by adding more agents, customizing their behavior, and integrating with other services as needed.
- Why do you need to host in Microsoft Foundry?
  ...
  - Management: Simplified management and monitoring of your AI models and applications.
  - Maintenance: Automatic updates and maintenance provided by Azure.
- if you host your self, right from infrastructure, scaling, security, monitoring everything is your responsibility.